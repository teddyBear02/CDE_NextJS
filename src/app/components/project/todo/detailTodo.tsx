        ...
        {isEdit ? (
               ...
               <form action="#">
                 <div className="sub-section">
                   <div className="input-group">
                     ...
                     <div className="input-focus-group">
                       <input
                         type="text"
                         onChange={(event) => handleDataFormChange("title", event.target.value)}
                 ...
                 <div className="sub-section">
                   <div className="input-group">
                     ...
                     <div className="input-focus-group">
                       <input
                         type="email"
                         onChange={(event) => handleDataFormChange("assginTo", event.target.value)}
                 ...
                 <div className="sub-section">
                   <div className="input-group">
                     ...
                     <div className="input-focus-group">
                     <textarea onChange={(event) => handleDataFormChange("descriptions", event.target.value)}  value={data?.descriptions} ></textarea>
                     </div>
                   </div>
                 </div>
                 ...
                 <div className="sub-section">
                   ...
                   <label htmlFor="">Ngày bắt đầu</label>
                    <ReactDatePicker 
                       ...
                       onChange={(date) => handleDataFormChange("startDate", date)} 
                    />
                    </div>
                 </div>
                  <div className="sub-section">
                 ...
                 <div className="sub-section">
                   <div className="input-group">
                     ...
                     <div className="input-focus-group">
                      <select name="" id="" value={dataFormEdit.state} onChange={(e) => handleDataFormChange("state", e.target.value)}>
           ...
           <footer className="editFooter">
             <div className="wrap-btns">
               ...
               <button disabled={isCallingApiEdit} className="editBtns" id="editSave" onClick={()=> handleSubmitFormEdit()}>
                 Lưu
               </button>
             </div>
           </footer>
              ...
              <div className="sub-section">
                ...
                <div className="section-details">
                  <div className="label-group">
                    ...
                    <div className="value no-ellipsis text-prewrap">{data.descriptions ?? '--'}</div>
                  </div>
                  <div className="label-group">
                    <label>Due date: </label>
                    <div className="value ">{data.created_at ? formatDate(data.finish_date) : '--'}</div>
                  </div>
                  <div className="label-group">
                    <label>Type</label>
                  ...
                  <div className="label-group">
                    <label>Status</label>
                    <div className="value ">{data.status ? getStatusLabel(data.status) : '--'}</div>
                  </div>
                  <div className="label-group">
                  ...
                  <div className="label-group">
                    <label>Created</label>
                    <div className="value ">
                      {`${formatDate(data.created_at)} By ${data.user_create.email}`}  
                    </div>
                  </div>
                  <div className="label-group">
                    <label>Modified</label>
                    <div className="value ">
                    {`${formatDate(data.updated_at)} By ${data.user_create.email}`}                      </div>
                  </div>
                </div>
              </div>
              <div className="sub-section">
